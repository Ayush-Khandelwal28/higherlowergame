...
export const LandingPage: React.FC<LandingPageProps> = ({ onMystery, onClassic, onTimedMystery, onTimedClassic, totalSubreddits }) => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-10 px-6 py-12 bg-gradient-to-br from-[#ffe5d6] via-[#fff7f3] to-white text-[#1a1a1b]">
      ...
      <div className="flex flex-col gap-5 w-full max-w-sm">
        ...
        <button onClick={onTimedMystery} className="group relative overflow-hidden rounded-2xl px-8 py-5 font-extrabold text-lg tracking-wide bg-gradient-to-br from-[#ff4500] via-[#ff8717] to-[#ff4500] text-white shadow-lg hover:shadow-xl transition-all">
          <span className="relative z-10">Beat The Clock · Mystery</span>
          <span className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.18),transparent_60%)] opacity-0 group-hover:opacity-100 transition-opacity" />
        </button>
        <button onClick={onTimedClassic} className="group relative overflow-hidden rounded-2xl px-8 py-5 font-extrabold text-lg tracking-wide bg-gradient-to-br from-[#ff8717] via-[#ff4500] to-[#ff8717] text-white shadow-lg hover:shadow-xl transition-all">
          <span className="relative z-10">Beat The Clock · Classic</span>
          <span className="absolute inset-0 bg-[radial-gradient(circle_at_40%_60%,rgba(255,255,255,0.18),transparent_60%)] opacity-0 group-hover:opacity-100 transition-opacity" />
        </button>
